...
class Admin extends MY_Controller 
{
	...
	public function user_crud() 
	{
		...
		if ($state == 'edit' || $state == 'update' || $state == 'update_validation') {
			...
			$crud->set_rules('passwd', 'Contraseña', 'min_length[8]|max_length[72]|callback_validate_passwd');
		}
	...
	{
		$view["body"]  = $this->load->view("admin/dashboard/welcome", NULL, TRUE);
		$view["breadcrumb"]  = breadcrumb_admin("Informacion");
		$view["title"] = "Informacion";
	...
	public function category_list()
	{
        ...
        $output = $crud->render();
		$view["grocery_crud"] = json_encode($output);
		$view["breadcrumb"]  = breadcrumb_admin("categorias");
